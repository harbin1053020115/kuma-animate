    ...
    return Tip.extend({
        ...
        setup: function() {
            ...
            this.after("render", function() {
                ...
                this.element.find('[data-role="confirm"]').on("click", function(ev) {
                    ev.preventDefault();
                    _this.hide();
                    typeof success == "function" && success();
                });
                this.element.find('[data-role="cancel"]').on("click", function(ev) {
                    ev.preventDefault();
                    _this.hide();
...
define("alinw/tip/2.2.4/tipconfirm-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
    ...
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        ...
        function program4(depth0, data) {
            return "kuma-tip-confirm-content-has-type";
        }
        function program6(depth0, data) {
            var buffer = "", stack1;
            buffer += '\n            <a class="kuma-button kuma-button-sblue" href="#" data-role="confirm">';
        ...
        function program8(depth0, data) {
            var buffer = "", stack1;
            buffer += '\n            <a class="kuma-button kuma-button-swhite" href="#" data-role="cancel">';
        ...
        buffer += '<div class="kuma-tip-confirm">\n    <div class="kuma-tip-confirm-title">';
        stack1 = helpers["if"].call(depth0, depth0.type, {
            hash: {},
            inverse: self.noop,
...
define("alinw/tip/2.2.4/tip-debug", [ "$-debug", "arale/tip/1.2.2/tip-debug", "arale/popup/1.1.6/popup-debug", "arale/overlay/1.1.4/overlay-debug", "arale/position/1.0.1/position-debug", "arale/iframe-shim/1.0.2/iframe-shim-debug", "arale/widget/1.1.1/widget-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug" ], function(require, exports, module) {
    ...
    var tip = araleTip.extend({
        ...
        _onRenderVisible: function(val, originVal) {
            ...
            if (val) {
                if (this.get("effect")) this.element.addClass(this.get("effect"));
            } else {
                if (this.get("effect")) this.element.removeClass(this.get("effect"));
            }
        }
    });
    module.exports = tip;
